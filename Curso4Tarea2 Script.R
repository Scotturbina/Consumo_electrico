...
library(lubridate)
#detach(package:plyr)
setwd("C:/Users/HP/Documents/Big data posgrado/Clase 4 Tarea 1")
...
Primavera<- subset(cleanConsumption, Date= "marzo" | Month== "abril" | Month== "mayo" )

Primavera$Estacion<-"Primavera"

Verano<-subset(cleanConsumption, Month== "junio" | Month== "agosto" | Month== "setiembre" )
